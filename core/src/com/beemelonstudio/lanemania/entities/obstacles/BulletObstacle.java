...
public class BulletObstacle extends Entity {

    public BulletObstacle(Body body, String name, float width, float speed, float rotationSpeed, boolean circle, float timer) {
        super(body);
